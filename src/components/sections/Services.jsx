...
export default function Services() {
    return (
        ...
        linear-gradient(to right, white 1px , transparent 1px)`, backgroundSize: '30px 30px'
                }} />
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <FadeIn delay={0}>
                    <div className="text-center mb-16">
                        ...
                        <h2 className="text-4xl lg:text-5xl font-normal text-white mb-4 max-w-2xl mx-auto"> Turning Ideas Into Digital Experiencese</h2>
                        <p className="text-lg text-white/60 max-w-xl mx-auto">  From responsive websites to interactive web applications, I build
                            solutions that combine clean design, performance, and usability.</p>
                    </div>
                </FadeIn>
                        ...
                        return (
                            <FadeIn key={service.id} delay={100 + index * 100}>
                                <div className="group relative bg-white/5 border border-white/10 rounded-3xl p-8 hover:border-primary/30 transition-all duration-300 h-full min-h-70 flex flex-col ">
                                    ...
                                    <div className="absolute inset-0 bg-linear-to-br from-primary/10 to-primary/0 group-hover:from-primary/5 group-hover:to-primary/5 rounded-3xl transition-all duration-300 pointer-events-none" />
                                </div>
                            </FadeIn>
                        )
                    })}
